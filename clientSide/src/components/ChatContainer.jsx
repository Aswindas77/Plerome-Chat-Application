...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return (
    ...
    >
      <p
        className={`p-2 max-w-[200px] md:text-sm font-light mb-8 break-all bg-violet-500/30 text-white
          ${isMe ? "rounded-br-none" : "rounded-bl-none"} rounded-lg`}
      >
